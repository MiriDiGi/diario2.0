                  ...
                  <div class="grid-container">
                      <form action="<%= request.getContextPath()%>/register" method="post">
                          <div class="form_group field">
                              <div class="item1"> 
                                  <input type="text" name="nome" placeholder="Nome" class="form_field" required>
                                  <span class="focus-border"></span>
                              </div>
                              <div class="item2"> 
                                  <input type="text" name="cognome" placeholder="Cognome" class="form_field" required>
                                  <span class="focus-border"></span>
                              </div>
                              <div class="item1"> 
                              ...
                              <div class="item3"> 
                                  <input type="email" name="email" placeholder="Email" class="form_field" required>
                                  <span class="focus-border"></span>
                              </div>
                           <!--   <div class="item4">
